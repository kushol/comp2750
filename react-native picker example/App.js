...
export default function App() {
  ...
  <SafeAreaView style={styles.container}>
    ...
    <View style={styles.row2}>
      <Picker style={styles.picker1} selectedValue={picker1SelectedValue} 
              onValueChange={(itemValue, itemIndex) => setPicker1SelectedValue(itemValue)}>
        <Picker.Item label="COMP1000-2" value="val-COMP1000-2" />
        <Picker.Item label="COMP1750-3" value="val-COMP1750-3" />
        <Picker.Item label="COMP2750-4" value="val-COMP2750-4" />
      </Picker>
      <Picker style={styles.picker2} selectedValue={picker2SelectedValue} 
